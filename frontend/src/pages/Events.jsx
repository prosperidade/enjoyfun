...
export default function Events() {
  ...
  // Função load memorizada com useCallback para resolver o erro de dependência do useEffect
  ...
  }, [search]); // Ela só muda se o termo de busca mudar

  // useEffect agora está correto com a dependência 'load'
  useEffect(() => {
    load();
  }, [load]);
