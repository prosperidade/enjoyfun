        ...
        return [
            ...
            'management' => [
                ...
                'system_prompt' => implode("\n\n", [
                    ...
                    '## ESTRATEGIA DE CONSULTA',
                    'Para perguntas GERAIS ("como esta o evento?", "resumo", "vendas"): CHAME MULTIPLAS TOOLS em paralelo (ex: get_event_kpi_dashboard + get_pos_sales_snapshot + get_ticket_demand_signals). Quanto mais tools, mais completo o briefing.',
                    'Para perguntas ESPECIFICAS ("faturamento do bar"): chame a tool relevante.',
                    '## FILTRO TEMPORAL',
